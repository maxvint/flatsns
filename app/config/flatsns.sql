...
-- 数据库: `flatsns`
--
CREATE DATABASE IF NOT EXISTS `flatsns` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `flatsns`;
...
CREATE TABLE IF NOT EXISTS `pre_topic` (
...
INSERT INTO `pre_topic` (`tid`, `uid`, `title`, `content`, `addtime`, `updatetime`, `lastreply`, `views`, `replys`, `is_top`, `is_hide`, `status`) VALUES
...
(14, 2, '', '', 1385548065, 1385548065, 1385548065, 0, 0, 0, 0, 1);
...
INSERT INTO `pre_user` (`uid`, `username`, `password`, `openid`, `email`, `avatar`, `homepage`, `money`, `signature`, `forums`, `replies`, `notices`, `follows`, `regtime`, `lastlogin`, `lastpost`, `qq`, `group_type`, `gid`, `ip`, `location`, `token`, `introduction`, `is_active`) VALUES
(1, 'yuwenhui1986', '96e79218965eb72c92a549dd5a330112', '', 'yuwenhui1986@163.com', NULL, NULL, 100, NULL, 0, 0, 0, 0, 1385523862, NULL, NULL, NULL, 2, 3, '120.192.230.202', NULL, NULL, NULL, 1),
